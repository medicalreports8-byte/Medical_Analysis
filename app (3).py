# ============================================================
# 🩺 Medical Report Analyzer — Groq Free Version
...
st.markdown("""<div class="main-header">
  ...
  <p style="color:#64748b;margin-top:6px">AI-powered clinical analysis • Powered by Llama 3.3 (Groq)</p>
</div>""", unsafe_allow_html=True)

# ── Input: text only (no file upload to avoid library issues) ─
st.markdown("**✏️ Paste your medical report text below**")
report_text = st.text_area(
    "",
    height=250,
    placeholder="Paste your lab report, blood work results, radiology report, or any medical report text here...",
    label_visibility="collapsed"
)

if st.button("🧠 Analyze Medical Report"):
    if not report_text.strip():
        st.error("⚠️ Please paste your report text above.")
    else:

# ============================================================
# 🩺 Medical Report Analyzer — Groq Free Version (no groq package)
# Run:  pip install streamlit PyMuPDF Pillow pytesseract
...
def analyze_report(text=None, file_bytes=None, file_type=None):
    ...
    # Call Groq API directly using requests (no groq package needed)
